        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content rounded-4 shadow" style="width: 100%;">
                ...
                <div class="d-grid gap-2">
                     <a href="/disciplina" class="btn btn-outline-danger rounded-0">Novo Registro</a>
                  </div>
                <div class="bd-example-snippet bd-code-snippet">
                    <div class="bd-example">
                        <table class="table table-dark table-hover">
                            ...
                            <tbody>
                                @foreach ($disciplinas_niveis as $disciplinas_nivel)
                                    <tr>
                                        <td>{{ $disciplinas_nivel->id }}</td>
                                        <td>{{ $disciplinas_nivel->titulo }}</td>
                                        <td>{{ $disciplinas_nivel->descricao }}</td>
                                        <td>{{ $disciplinas_nivel->requisito }}</td>
                                        <td>{{ $disciplinas_nivel->bonus }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
