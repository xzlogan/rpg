        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-header p-5 pb-4 border-bottom-0">
                    ...
                    <h1 class="fw-bold mb-0 fs-2">Cadastro da Habilidade</h1>

                </div>
                <div class="modal-body p-5 pt-0">
                    <form accept="/habilidade" method="post">
                        @csrf  
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control rounded-3" id="nome"
                                placeholder="name@example.com" name="nome">
                            <label for="floatingInput" class="text-danger">Nome do Habilidade</label>
                        </div>
                        <div class="form-floating mb-3">
